...
public class SepanjInn{
    ...
    private static final String VERSION = "Version 1.0 ©TeamSepanj";
    //top panel of frame
    private JPanel top;
     ...
     */
    public SepanjInn(AirbnbDataLoader airbnbDataLoader) { 
        frame = new JFrame("SEPANJ");
        // try {
            // frame.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("Sepanj.jpg")))));
        // } catch (IOException e) {
            // e.printStackTrace();
        // }
        makeFrame(frame);
    ...
    private void makePriceComboBoxes()
    {
        ...
        //pricePanel.add(Logout);
        pricePanel.add(LogoutButton);
    ...
    private void makeLogoPane()
    {
        ...
        JLabel logo = new JLabel(new ImageIcon("logo2.png")); //logo2.png
