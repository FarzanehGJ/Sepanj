...
public class QuizPanel extends JPanel
{
   ...
   private void makeQuizPanel()
   {
       ...
       // JLabel questionLabel = new JLabel("What is your purpose for travel to Tehran? Work or Holiday?");
       // slider = new JSlider();
       // JLabel questionLabel = new JLabel("What is your purpose for travel to Tehran? Work or Holiday?");
       // makeSlider(slider,"What is your purpose for travel to Tehran? Work or Holiday?");
   ...
   private void makeResultPanel(AirbnbListing dreamHome)
   {
       ...
       JLabel jupiterInfo = new JLabel("<html>Here at SepanjInn, we utlise state of the art alogirthms<br>" +
